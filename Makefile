...
UMBRELLACTL = /usr/local/bin/umbrellactl

.PHONY: all build install uninstall clean restart install-agent uninstall-agent setup-sudoers remove-sudoers
...
setup-sudoers:
	...
	@echo "$$SUDO_USER ALL=(ALL) NOPASSWD: $(UMBRELLACTL)" > $(SUDOERS_FILE)
